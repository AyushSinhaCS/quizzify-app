                    ...
                    return (
                        <div key={index} className="p-6 bg-white dark:bg-gray-800 rounded-lg shadow-md">
                            <div className="flex justify-between items-start mb-4">
                                ...
                                {isCorrect ? (
                                    <FiCheckCircle className="text-green-500 text-2xl ml-4 flex-shrink-0" />
                                ) : (
                                    <FiXCircle className="text-red-500 text-2xl ml-4 flex-shrink-0" />
                                )}
                            </div>
                            <div className="space-y-3">
                                {question.options.map((option, optIndex) => {
                                    ...
                                    if (isCorrectAnswer) {
                                        style = "border-green-500 bg-green-100 dark:bg-green-900/50 text-gray-800 dark:text-gray-100";
                                    }
                                    if (isSelected && !isCorrect) {
                                        style = "border-red-500 bg-red-100 dark:bg-red-900/50 text-gray-800 dark:text-gray-100";
                                    }
